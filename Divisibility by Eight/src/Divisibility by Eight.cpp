...
std::string div8[] = {"0", "8", "16", "24", "32", "40", "48", "56", "64",
		...
		"512", "520", "528", "536", "544", "552", "560", "568", "576",
		"584", "592", "600", "608", "616", "624", "632", "640", "648",
		"656", "664", "672", "680", "688", "696", "704", "712", "720",
		"728", "736", "744", "752", "760", "768", "776", "784", "792",
...
int main() {
	...
	for(int i = 0; i < 125; i++){
		...
		for(int j = 0; j < canbe.length(); j++){
			if(canbe[j] == div8[i][pos]){
				pos++;
				if(pos == div8[i].length()){
					std::cout << "YES" << std::endl;
					std::cout << div8[i] << std::endl;
					return 0;
				}
			}
		}
